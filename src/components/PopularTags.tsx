        ...
        <div className="p-4 rounded-2xl border-[1px] border-borderGray flex flex-col gap-4">
            ...
            <div className="flex gap-4">
                ...
                <div className="flex-1">
                    <h2 className="font-bold text-textGrayLight"> Nadal v Federal Grand Slam</h2>
            ...
            <div>
                <div className="flex items-center justify-between">
                    <span className="text-textGrayLight text-sm">Technology . Trending</span>
                    <Image path="icons/infoMore.svg" alt="info" w={16} h={16} />
                </div>
                <h2 className="text-textGrayLight">OpenAI</h2>
